...
public class Navigation {
	final static int FAST = 200, SLOW =50, ACCELERATION = 500;
	...
	/**
	 * This method sets the speed and direction of left and right motor. 
	 * @param lSpd
	 * @param rSpd
	 */
	...
	public void turnTo(double angle, boolean stop) {
		...
		double error = angle - this.odometer.getXYT()[2];
		int counter = 0;

		while (Math.abs(error) > DEG_ERR && counter<10000) {

			error = angle - this.odometer.getXYT()[2];
